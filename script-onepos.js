...
function init() {
  ...
  mouseX = stageWidth * 0.25;
  mouseY = stageHeight * 0.35;
  idleBurst();
...
function createParticle(burst) {
	...
	particle.x = stageWidth * 0.95;
	particle.y = stageHeight * 0.85;
	particle.vx = (burst) ? (0.5 - Math.random()) * 80 : lastX - mouseX;
	particle.vy = (burst) ? (0.5 - Math.random()) * 80 : lastY - mouseY;
